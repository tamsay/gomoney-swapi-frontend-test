...
const SearchResult = (): JSX.Element=> {
	...
	const localStorageSearch = localStorage.getItem("searchQuery") as string;
	...
	useEffect(() => {
		...
		const search = searchQuery ? searchQuery : localStorageSearch;
		...
		case "characters":
			...
			const filteredCharacters = getFilteredArray(allCharactersArray, search);
		...
		case "planets":
			...
			const filteredPlanets = getFilteredArray(allPlanetsArray, search);
		...
		case "starships":
			...
			const filteredStarships = getFilteredArray(allStarshipsArray, search);
